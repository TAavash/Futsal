...
//             <img
//               src={court.courtImage || DefaultCourtImage} // Use default image if courtImage is not available
//               alt={court.name}
...
//             <p className="text-sm text-gray-600">Price: Rp {court.pricePerHour}</p>
